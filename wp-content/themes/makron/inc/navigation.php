...
class Makron_Nav_Walker extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_html = apply_filters( 'mak_menu_item', $item_html );
        $output .= $item_html;
    }
...
function mak_menu_css_class( $classes, $item ) {
...
add_filter('nav_menu_css_class', 'mak_menu_css_class', 10, 2);
