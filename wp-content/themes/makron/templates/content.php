 ...
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('mak-cf'); ?>>
    <div class="post-date">
        ...
        <div class="header-metas">
            ...
            <span class="post-date-mobile">
                <time class="published" datetime="<?php echo get_the_time('c'); ?>">
                    <a title="<?php _e( 'Permalink to: ', 'makron' ); echo the_title(); ?>" href="<?php the_permalink(); ?>"><?php echo get_the_date(); ?></a>
                </time>
            </span>
    ...
    <div class="post-content">
        ...
        <?php if( is_singular() ) :
            ...
            the_excerpt(); ?>
            <a class="read-more" href="<?php the_permalink(); ?>"><i class="g"></i><?php echo _e( 'Read more &raquo;', 'makron' ); ?></a>
